...
function TechnicalDetails() {
  return (
    <Layout>
      ...
      {/* ================= System Pipeline ================= */}
      <div className="mt-16 max-w-4xl rounded-2xl border bg-white p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 text-center text-sm">
          {[
            ...
            <div
              key={idx}
              className="rounded-xl border bg-slate-50 px-4 py-6 font-medium"
            >
              {step}
            </div>
          ))}
      ...
      {/* ================= Dataset ================= */}
      <section className="mt-16 max-w-4xl rounded-2xl border bg-white p-8">
      ...
      <section className="mt-16 max-w-4xl">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-3">
          {[
            ...
            <div
              key={feature}
              className="rounded-xl border bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700"
            >
              {feature}
            </div>
          ))}
